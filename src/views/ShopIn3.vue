        ...
        <main>
            ...
            <div>
                ...
                <div class="biz_info">
                    ...
                    <button type="button">사업자등록번호 진위 여부 확인</button>
                </div>
            ...
            <button type="button" class="nextbtn" @click="toShopIn4()">다음</button>
        </main>
    </div>
</template>
...
.company_info > input:nth-of-type(1) {
