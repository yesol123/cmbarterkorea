    ...
    <main>
        ...
        <div class="info">
            ...
            <div class="call_map">
                ...
                <button type="button"><a :href="`tel:${shopinfo.store_phone}`"><img src="@/assets/call.png" alt="전화이미지"></a></button>
                <button type="button" @click="GetStoreIndex(shopinfo.store_index)"><img src="@/assets/location.png" alt="위치이미지"></button>
            </div>
        </div>
        <div class="space"> 
            정보
